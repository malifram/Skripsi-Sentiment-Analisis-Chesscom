...
# =========================================================
# LOAD RESOURCE (model, vectorizer, stemmer, stopwords, slang)
...
# cleaning -> normalisasi slang -> tokenizing -> stopword removal -> stemming
# =========================================================
...
def preprocess_kalimat(text: str) -> str:
    ...
    # FIX: normalisasi slang & istilah chess SEBELUM tokenizing, supaya kata
    # seperti "cheater", "bot", "bgt", "byk" dikenali oleh model
...
# UI STREAMLIT
# =========================================================
st.title("♙ Analisis Sentimen Ulasan Chess.com")
...
with st.expander("ℹ️ Tentang aplikasi ini"):
    st.write(
        ...
        kemudian dipakai untuk melatih model Support Vector Machine (SVM) sesuai ruang lingkup penelitian.
        """
    )
